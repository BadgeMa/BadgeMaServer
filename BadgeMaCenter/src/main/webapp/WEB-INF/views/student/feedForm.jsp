...
<body>
	<div class="wrapper">
		...
		-->
			<div class="logo">
				<a href="<%=server%>/studentFeed.do" class="simple-text"> Badge
					Ma </a>
			</div>
			...
			<div class="sidebar-wrapper">
				<div class="user">
					<div class="photo">
						<img width="60" height="60"
							src="resources/common/dashboard/assets/img/faces/badgema_logo.png" />
					</div>
					<div class="info">
						<a data-toggle="collapse" href="#collapseExample"
							class="collapsed"> 학생 <b class="caret"></b>
						</a>
				...
				<ul class="nav">
					<li><a href="<%=server%>/studentFeed.do"> <i
							class="ti-book"></i>
							<p>대나무 숲</p>
					</a></li>
					<li class="active"><a href="<%=server%>/studentFeedForm.do">
							<i class="ti-notepad"></i>
							<p>사연 신청</p>
					</a></li>
					<li><a href="<%=server%>/studentAdvice.do"> <i
							class="ti-comments"></i>
							<p>고민있어요</p>
					</a></li>
				</ul>
			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<%=server%>/studentFeedForm.do">사연신청</a>
					</div>
				</div>
			</nav>
				...
				<div class="container-fluid">
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="content">
								<form method="POST" action="<%=server %>/insertFeed.do" class="form-horizontal">

									<fieldset>
										<div class="form-group">
											<label class="col-sm-2 control-label">하고 싶은 말</label>
											<div class="col-sm-10">
												<textarea id="feedform_context" name = "feedform_context" class="form-control"
													placeholder="대나무 숲에 올리고 싶은 내용을 적어주세요 :)" rows="3"></textarea>
											</div>
										</div>
									</fieldset>
									<fieldset>
										<div class="form-group">
											<label class="col-sm-2 control-label">비밀댓글</label>
											<div class="col-sm-10">
									...
									<fieldset>
										<div class="form-group">
											<div class="card-footer">
												<button type="submit" class="btn btn-info btn-fill pull-right">사연 신청</button>
											</div>
										</div>
									</fieldset>
								</form>
