studentadvice = {
		adviceFormClick : function() {
			...
			$('#advice_content').html('<div class="content" id="advice_content"><div class="form-group"><label>여러분의 이야기를 적어주세요</label><textarea class="form-control" placeholder="어떤 고민이 있으신가요?"rows="6"></textarea></div><div class="form-group"><label>Password</label><input type="password"placeholder="Password" class="form-control"></div></div><div class="footer text-center"><Button class="btn btn-fill btn-wd btn-info"style="margin-bottom: 15px">확인</Button></div>');
		},
		adviceList : function() {
